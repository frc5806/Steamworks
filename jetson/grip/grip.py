...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [41.62385249309404, 92.23793941146276]
        self.__hsv_threshold_saturation = [0.0, 255.0]
        self.__hsv_threshold_value = [222.76464527030643, 255.0]
        ...
        self.__filter_contours_solidity = [51.927029314658625, 100.0]
